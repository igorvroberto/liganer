...
/** Todos os campos do CSV (exceto id e linha — linha tem UI própria) */
export const EDITABLE_FIELDS: {
  ...
  { key: 'tipo_operacao', label: 'Tipo de operação', kind: 'textarea' },
  { key: 'o_que_fabrica_constroi', label: 'O que fabrica / constrói', kind: 'textarea' },
  { key: 'obras_atuais', label: 'Obras atuais', kind: 'textarea' },
  ...
  { key: 'necessidade_identificada', label: 'Necessidade identificada', kind: 'textarea' },
